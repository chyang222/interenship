...
out_index = pd.read_csv('/home/datanuri/yjjo/python_scripts/address_outlier.csv', encoding = 'utf-8-sig') 
filePath, fileName = '/home/datanuri/yjjo/python_scripts', 'ych_out_address.py'
...
def main():
    try:
        ...
        address_report_format.to_csv("/home/datanuri/yjjo/python_scripts/Report/12333.csv", encoding = 'utf-8-sig')
